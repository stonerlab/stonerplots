...
.. British English formatting applied throughout.
...
~~~~~~~~~~~~~~~~~~~~~~
The *width*, *height* and *dimension* parameters control the size of the inset axes (note this does not include any axes
